export const Icons = {
  ...
  instagram: {
    paths: [
      {
        d: "M16 2H8C4.686 2 2 4.686 2 8v8c0 3.314 2.686 6 6 6h8c3.314 0 6-2.686 6-6V8c0-3.314-2.686-6-6-6zm4 14c0 2.21-1.79 4-4 4H8c-2.21 0-4-1.79-4-4V8c0-2.21 1.79-4 4-4h8c2.21 0 4 1.79 4 4v8zm-5-8.5A1.5 1.5 0 1 1 13.5 7 1.5 1.5 0 0 1 15 7.5zm-3 1a4.5 4.5 0 1 1-4.5 4.5A4.505 4.505 0 0 1 12 8.5m0-2a6.5 6.5 0 1 0 6.5 6.5A6.507 6.507 0 0 0 12 6.5z",
      },
    ],
  ...
  whatsapp: {
    paths: [
      {
        d: "M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.418 0-8-3.582-8-8 0-4.417 3.582-8 8-8 4.418 0 8 3.583 8 8 0 4.418-3.582 8-8 8zm3.35-6.162c-.34-.16-2.015-1.005-2.327-1.12-.31-.115-.54-.173-.77.18-.225.346-.87 1.19-1.066 1.423-.196.233-.393.262-.732.098-.34-.165-1.432-.53-2.728-1.682-.99-.88-1.656-1.968-1.85-2.308-.195-.34-.02-.524.146-.69.15-.15.34-.39.512-.586.165-.19.218-.33.337-.533.1-.17.05-.336-.015-.47-.067-.134-.72-1.73-.99-2.394-.26-.63-.527-.544-.72-.544h-.588c-.195 0-.45.067-.68.326-.23.26-.895.875-.895 2.133 0 1.26.92 2.482 1.05 2.65.13.17 1.81 2.83 4.425 3.966 1.71.74 2.365.802 3.215.68.49-.073 1.585-.645 1.808-1.27.223-.625.223-1.16.16-1.27-.063-.11-.23-.17-.47-.28z",
      },
    ],
    class:"h-4 w-4 flex-shrink-0 fill-current text-neutral-700 dark:text-neutral-400",
    viewBox: "0 0 24 24",
  ...
  telegram: {
    paths: [
      {
        d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.93 7.07-1.43 6.43c-.1.45-.36.56-.74.35l-2.07-1.52-1 .96c-.1.1-.2.19-.41.19l.14-2.05 3.74-3.36c.16-.14-.04-.23-.25-.09L8.7 13.61l-1.99-.62c-.43-.14-.44-.43.09-.64l9.08-3.52c.43-.17.81.1.66.64z",
      },
    ],
    class:"h-4 w-4 flex-shrink-0 fill-current text-neutral-700 dark:text-neutral-400",
    viewBox: "0 0 24 24",
  ...
  linkedin: {
    paths: [
      {
        d: "M4.98 3.5C4.98 4.328 4.328 5 3.5 5S2 4.328 2 3.5 2.672 2 3.5 2s1.48.672 1.48 1.5zM4.98 21H2V7h2.98v14zM22 21h-2.98v-7.356c0-1.95-.035-4.456-2.718-4.456-2.718 0-3.132 2.123-3.132 4.32V21H10.18V7h2.85v1.907h.041c.397-.75 1.365-1.542 2.81-1.542 3.005 0 3.56 1.975 3.56 4.54V21z",
      },
    ],
